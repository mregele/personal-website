---
title: "The System Works Because People Work Around It"
description: "Workers often discover better ways to do their jobs than the official procedures allow. When organizations make work more visible, employees may hide the adaptations that actually keep things running."
pubDate: 2026-07-24
image: "/images/factory_monitoring.png"
...
This was one of the more surprising findings in [Ethan Bernstein's study](https://doi.org/10.1177/0001839212453028) of a large mobile phone factory in China. Workers had developed "little tricks" that allowed them to perform their jobs faster and sometimes more safely. They shared these techniques quietly with one another. They also learned to abandon them whenever a manager, customer, or other outsider came near.
...
We already recognize the value of protected experimentation in some settings. [Google's well-known "20 percent time"](https://abc.xyz/investor/founders-letters/2004/default.aspx) is the clearest example. The point was not that employees should spend one day each week doing whatever they wanted. It reflected a different assumption. Some employees might discover something valuable if they were given room to depart from their assigned work.
...
People closest to the work often discover things the formal system does not know. As [research on organizational routines](https://doi.org/10.2307/3556620) has shown, routines are continually recreated through the way people perform them. Employees identify unnecessary steps, solve recurring problems, and quietly adapt procedures to reality.
